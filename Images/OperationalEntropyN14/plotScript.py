...
#Top Plot: One Particle Entanglement entropy dependence on the interaction potential
    ...
    #Spatial 2nd Renyi
    s2NEG_M28N14spatial = dataNEG_M28N14[:,4]
    s2_M28N14spatial = data_M28N14[:,4]
    ...
    ax1.plot(energiesNEG_M28N14, s1NEG_M28N14spatial, 'o',  label=r'$S_{1}$', markersize = 3, markerfacecolor = 'None', markeredgewidth = '0.25', color=blue[0])
    ax1.plot(energiesNEG_M28N14, s2NEG_M28N14spatial, 'o',  label=r'$S_{2}$', markersize = 3, markerfacecolor = 'None', markeredgewidth = '0.25', color=orange[0])
    ax1.plot(energiesNEG_M28N14, s1NEG_M28N14, 'o', label=r'$S_{1}^{\rm{acc}}$', markersize = 3, markerfacecolor = blue[1], markeredgewidth = '0.25',color=blue[0])
    ax1.plot(energiesNEG_M28N14, s2NEG_M28N14op5, 'o', label=r'$S_{2}^{\rm{acc}}$', markersize = 3, markerfacecolor = orange[1], markeredgewidth = '0.25',color=orange[0])
    ax1.set_xlim(-energies_M28N14[-1], -energies_M28N14[0])
    ax1.set_ylim(0,3.45)
    ax1.set_ylabel(r'$S_{\alpha}(\rho_A)$')
    ...
    ax2.plot(energies_M28N14, s1_M28N14spatial, 'o',  label=r'$1, S_{\alpha}$', markersize = 3, markerfacecolor = 'None', markeredgewidth = '0.25', color=blue[0])
    ax2.plot(energies_M28N14, s2_M28N14spatial, 'o',  label=r'$1, S_{\alpha}$', markersize = 3, markerfacecolor = 'None', markeredgewidth = '0.25', color=orange[0])
    ax2.plot(energies_M28N14, s1_M28N14, 'o', label=r'$1, S_{\alpha}^{\rm{acc}}$', markersize = 3, markerfacecolor = blue[1], markeredgewidth = '0.25',color=blue[0])
    ax2.plot(energies_M28N14, s2_M28N14op5, 'o', label=r'$2, S_{\alpha}^{\rm{acc}}$', markersize = 3, markerfacecolor = orange[1], markeredgewidth = '0.25',color=orange[0])
